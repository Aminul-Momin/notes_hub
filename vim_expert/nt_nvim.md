### Two Choices of Vim Emulator:

- **vim**
  - <font color=red size=5>`~/.vimrc`</font> $\rightarrow$ Configuration file
- **neovim**
  - <font color=red size=5> `~/.config/nvim/init.vim`</font> $\rightarrow$ Configuration file
  - `which nvim` $\rightarrow$ To check if neonim is installed on the machine
  - [neovim Quickstart](https://www.youtube.com/watch?v=tOjVHXaUrzo&t=68s)
...
- [NeoVim Configuration](https://www.youtube.com/watch?v=DogKdiRx7ls&t=516s):
  ...
  - <font color=red size=5>~/.config/nvim/init.vim</font>
